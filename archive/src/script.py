...
def parse_args(args: list[str]) -> tuple[any]:
    ...
    return nterms, subjects, filepath, ranges, include_summer, save_all, save_grouped
...
def run(argv: list[str]):
    ...
    """
    nterms, subjects, filepath, ranges, include_summer, save_all, save_grouped = parse_args(argv)
    loader = Loader()
    loader.compile_csv(
        nterms=nterms,
        subjects=subjects,
