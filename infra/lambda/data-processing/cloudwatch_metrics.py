"""
CloudWatch Metrics Module for Georgia Tech Enrollment Data Processing

This module provides utilities for sending custom metrics to CloudWatch
for monitoring API usage, processing times, and error rates.
"""
...
class CloudWatchMetrics:
    ...
    def __init__(self, namespace: str = "GaTech/EnrollmentData"):
        """
    ...
    def record_processing_metrics(
        ...
        Args:
            ...
            error_category: Optional error category for failed jobs
        """
        base_dimensions = {'JobType': job_type}
        ...
        if success:
            self.increment_counter('ProcessingSuccess', base_dimensions)
            ...
            self.increment_counter('ProcessingFailure', error_dimensions)
